...
def create_streamer(source, cam_id="Camera 1", connect_to='tcp://127.0.0.1:5555', 
    loop=True, width=1280, height=720):

    print(f"[{cam_id}] Starting stream to {connect_to}")
    # Determine if source is a file or RTSP
...
if __name__ == '__main__':
    ...
    parser.add_argument('--camera-id', default='Camera 1', help="Label shown in the stream overlay.")
